...
if (
  ...
  // if ghost and monsters occur in same location, restarts the game
  location.reload();
}
...
function spot(number) {
  ...
  if (counter < 1) {
    ...
    if (ghostCount === 2) {
      // if two ghosts, you win
      setTimeout(function () {
        //creates a delay of 100 miliseconds prior to executing alert
        alert("BOO! You won!");
      }, 100);
    }
  } else if (monster === number || monster2 === number) {
    //added second monster logic
